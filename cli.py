...
from schemas import sch_agent, sch_credit_card, sch_music_data, sch_rides, sch_users
...
kafka_topic_users_without_log_compaction_avro = os.getenv(
...
kafka_topic_users_without_log_compaction_json = os.getenv(
    "KAFKA_TOPIC_USERS_WITHOUT_LOG_COMPACTION_JSON"
)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="python application for ingesting data & events into a data store"
    )
